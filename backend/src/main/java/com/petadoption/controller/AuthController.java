...
public class AuthController {
    ...
    public Map<String, String> generateHash() { // http://localhost:8080/api/auth/test/generate-hash = after runnig the
                                                // backedn go to thsi weebiste for generated hash value
